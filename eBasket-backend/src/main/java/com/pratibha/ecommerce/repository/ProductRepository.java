...
public interface ProductRepository extends JpaRepository<Product, Integer>{
	...
	@Query("select p from Product p where p.category.categoryName=:category and p.productName like %:searchKey% or p.longDescription like %:searchKey% or p.shortDescription like %:searchKey% or p.category.categoryName like %:searchKey%")
